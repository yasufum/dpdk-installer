...
[type your account]
> update 'remote_user' to 'dpdk1805' in 'group_vars/all'.
...
使用方法の詳細については[DPDK Documentation](http://dpdk.org/doc/guides-18.05/)
を参照してください。
...
dpdk1805@remote:~$ cd dpdk_home/pktgen-dpdk/
```
...
```sh
dpdk1805@remote:~/dpdk_home/pktgen-dpdk$ sudo -E ./doit
```
